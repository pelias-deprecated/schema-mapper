 ...
 *
 *          "path": The path of the file to ingest, or an array of such paths
 *              if multiple files should be ingested with the same mapper.
...
/**
 * Create a reader for shapefiles.
 *
 * @param {Object} reader See `createReader()` `reader` argument documentation.
 * @return {readable-stream} See `createReader()` return value documentation.
 */
...
/**
 * Create a reader for CSVs (but also any general character -separated-values,
 * like TSVs).
 *
 * @param {Object} reader See `createReader()` `reader` argument documentation.
 * @return {readable-stream} See `createReader()` return value documentation.
...
/**
 * Create a reader for OSM PBF/XML files.
 *
 * @param {Object} reader See `createReader()` `reader` argument documentation.
 * @return {readable-stream} See `createReader()` return value documentation.
 */
