...
/**
 * Abstracted away in case the library ever moves away from an `eval()` model.
 *
 ...
 *
 *      Note that the leading property name in a property path does not *need*
 *      to be preceded by a ".", though it may be. "keyName" will be
 *      interpreted like ".keyName" (but "['keyName']" will be left as is).
 */
