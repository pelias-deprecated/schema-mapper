 ...
 *      ingested objects to values in objects pushed downstream. Keys represent
 *      keys in the remapped object, while their values (which can be either a
 *      function, strict, or object -- see `mapProperty()`) indicate how to
 *      retrieve a corresponding value from the original object.
