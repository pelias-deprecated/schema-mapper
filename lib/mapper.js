 ...
 *      to retrieve from `source` (eg "my.nested[0].value"). Note that the
 *      leading property name does not *need* to be preceded by a ".", though
 *      it may be. "keyName" will be interpreted like ".keyName" (but
 *      "['keyName']" will be left as is).
 */
